var app = angular.module('proyectoController',[]).controller('proyectoController', ['$rootScope','$scope','$http','$routeParams', '$window', 
	...
	switch(mi.tipo_resultado){
		case '0': $rootScope.page_title = 'Institucional [Proyecto]'; break;
		case '1': $rootScope.page_title = 'Resultados estratégicos [Proyecto]'; break;
		case '2': $rootScope.page_title = 'Resultados institucionales [Proyecto]'; break;
		case '3': $rootScope.page_title = 'Sin resultado [Proyecto]'; break;
	}
	...
	$http.post('/SProyecto',{
		...
		if(response.data.success){
			mi.dato = [];
			mi.dato = response.data.proyectos;
