<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div ng-controller="proyectoController as ctrl">
    	<div align="center" class="row" style="width: 90%; margin: 0 auto; font-size: 11px;">
	    	...
	    	<table st-table="ctrl.displayedCollection" st-safe-src="ctrl.rowCollection" class="table table-striped cuerpotabla">
				<thead>
					...
					<tr>
						<th st-sort="nombre_proyecto">Nombre</th>
					...
					<tr>
						<th colspan="1"><input st-search="nombre_proyecto" class="form-control" placeholder="Proyecto..." type="text"/></th>
					</tr>
				</thead>
				<tbody>
					<tr st-select-row="row" st-select-mode="single" ng-repeat="row in ctrl.displayedCollection" ng-click="ctrl.getGraficaIndividual(row);" ng-dblclick="ctrl.irActividad(row.id, row.nombre_proyecto)">
