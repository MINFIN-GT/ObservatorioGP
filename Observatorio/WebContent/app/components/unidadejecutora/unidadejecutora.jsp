<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <div ng-controller="unidadEjecutoraController as ctrl">
    	<div align="center" class="row" style="width: 90%; margin: 0 auto; font-size: 11px;">
	    	...
	    	<table st-table="ctrl.displayedCollection" st-safe-src="ctrl.rowCollection" class="table table-striped cuerpotabla">
				<thead>
					...
					<tr>
						<th colspan="1"><input st-search="nombre_unidad_ejecutora" class="form-control" placeholder="Unidad ejecutora..." type="text"/></th>
					</tr>
				</thead>
				<tbody>
