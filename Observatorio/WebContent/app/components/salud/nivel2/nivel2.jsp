<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <div ng-controller="nivel2Controller as ctrl">
	    <div align="center" class="row" style="width: 90%; margin: 0 auto; font-size: 11px;">
	    	<table style="width: 90%;" st-table="ctrl.displayedCollection" st-safe-src="ctrl.rowCollection" st-tree-table st-tree-init-open="false" st-selected-row="selectedRow" class="table table-striped">
				<thead>
					<tr>
			...
			<div class="graphics_footnote">Fuente de información SICOIN. Cifras en millones de Quetzales.</div>
	    </div>
	    <br>
		<br>
		<br>
