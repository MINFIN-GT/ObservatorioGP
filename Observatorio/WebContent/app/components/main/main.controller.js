var app = angular.module('observatorio', ['chart.js','smart-table','ui.grid','ui.grid.pinning','ngUtilidades']);
app.controller('mainController',['$rootScope','$scope','$http', 
	...
	mi.ano_p_ejecucion = mi.anio;
	mi.ano_p_ejecucion_1 = mi.anio-1;
	mi.ano_p_ejecucion_2 = mi.anio-2;
	mi.ano_p_ejecucion_3 = mi.anio-3;
	mi.ano_p_ejecucion_4 = mi.anio-4;
		...
		function(response){
			if (response.data.success){
				...
				if(mi.dato.length > 0){
					...
					mi.getGraficaProducto({metaDescripcion:'General', entidad: mi.entidad, unidadEjecutora: mi.unidadEjecutora, programa: mi.programa, subPrograma: mi.subPrograma, actividad: mi.actividad, obra: mi.obra});
				}
			}
		});
