		...
		try{
			if(CMemsql.connect()){
				query = String.join(" ", "select ejercicio, entidad, unidad_ejecutora, programa, subprograma, proyecto, obra, actividad, actividad_obra_nombre,", 
						...
						"avg(fisico_ejecutado_m1/if(fisico_asignado+ifnull(fisico_modificacion_m1,0)>0,fisico_asignado+ifnull(fisico_modificacion_m1,0),1)) p_fisico_m1,",
						"avg(fisico_ejecutado_m2/if(fisico_asignado+ifnull(fisico_modificacion_m2,0)>0,fisico_asignado+ifnull(fisico_modificacion_m2,0),1)) p_fisico_m2,",
						"avg(fisico_ejecutado_m3/if(fisico_asignado+ifnull(fisico_modificacion_m3,0)>0,fisico_asignado+ifnull(fisico_modificacion_m3,0),1)) p_fisico_m3,",
						"avg(fisico_ejecutado_m4/if(fisico_asignado+ifnull(fisico_modificacion_m4,0)>0,fisico_asignado+ifnull(fisico_modificacion_m4,0),1)) p_fisico_m4,",
						"avg(fisico_ejecutado_m5/if(fisico_asignado+ifnull(fisico_modificacion_m5,0)>0,fisico_asignado+ifnull(fisico_modificacion_m5,0),1)) p_fisico_m5,",
						"avg(fisico_ejecutado_m6/if(fisico_asignado+ifnull(fisico_modificacion_m6,0)>0,fisico_asignado+ifnull(fisico_modificacion_m6,0),1)) p_fisico_m6,",
						"avg(fisico_ejecutado_m7/if(fisico_asignado+ifnull(fisico_modificacion_m7,0)>0,fisico_asignado+ifnull(fisico_modificacion_m7,0),1)) p_fisico_m7,",
						"avg(fisico_ejecutado_m8/if(fisico_asignado+ifnull(fisico_modificacion_m8,0)>0,fisico_asignado+ifnull(fisico_modificacion_m8,0),1)) p_fisico_m8,",
						"avg(fisico_ejecutado_m9/if(fisico_asignado+ifnull(fisico_modificacion_m9,0)>0,fisico_asignado+ifnull(fisico_modificacion_m9,0),1)) p_fisico_m9,",
						"avg(fisico_ejecutado_m10/if(fisico_asignado+ifnull(fisico_modificacion_m10,0)>0,fisico_asignado+ifnull(fisico_modificacion_m10,0),1)) p_fisico_m10,",
						"avg(fisico_ejecutado_m11/if(fisico_asignado+ifnull(fisico_modificacion_m11,0)>0,fisico_asignado+ifnull(fisico_modificacion_m11,0),1)) p_fisico_m11,",
						"avg(fisico_ejecutado_m12/if(fisico_asignado+ifnull(fisico_modificacion_m12,0)>0,fisico_asignado+ifnull(fisico_modificacion_m12,0),1))) p_fisico_m12", 
