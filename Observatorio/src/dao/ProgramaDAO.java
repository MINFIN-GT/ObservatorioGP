		...
		try{
			if(CMemsql.connect()){
				query = String.join(" ", "select ejercicio, entidad, unidad_ejecutora, programa, programa_nombre,", 
						...
						"  (avg(fisico_ejecutado_m1/ifnull(if(fisico_asignado+fisico_modificacion_m1>0,fisico_asignado+fisico_modificacion_m1,1),1)) * avg(financiero_vigente_m1)) p_fisico_m1,", 
						"  (avg(fisico_ejecutado_m2/ifnull(if(fisico_asignado+fisico_modificacion_m2>0,fisico_asignado+fisico_modificacion_m2,1),1)) * avg(financiero_vigente_m2)) p_fisico_m2,", 
						"  (avg(fisico_ejecutado_m3/ifnull(if(fisico_asignado+fisico_modificacion_m3>0,fisico_asignado+fisico_modificacion_m3,1),1)) * avg(financiero_vigente_m3)) p_fisico_m3,", 
						"  (avg(fisico_ejecutado_m4/ifnull(if(fisico_asignado+fisico_modificacion_m4>0,fisico_asignado+fisico_modificacion_m4,1),1)) * avg(financiero_vigente_m4)) p_fisico_m4,", 
						"  (avg(fisico_ejecutado_m5/ifnull(if(fisico_asignado+fisico_modificacion_m5>0,fisico_asignado+fisico_modificacion_m5,1),1)) * avg(financiero_vigente_m5)) p_fisico_m5,", 
						"  (avg(fisico_ejecutado_m6/ifnull(if(fisico_asignado+fisico_modificacion_m6>0,fisico_asignado+fisico_modificacion_m6,1),1)) * avg(financiero_vigente_m6)) p_fisico_m6,", 
						"  (avg(fisico_ejecutado_m7/ifnull(if(fisico_asignado+fisico_modificacion_m7>0,fisico_asignado+fisico_modificacion_m7,1),1)) * avg(financiero_vigente_m7)) p_fisico_m7,", 
						"  (avg(fisico_ejecutado_m8/ifnull(if(fisico_asignado+fisico_modificacion_m8>0,fisico_asignado+fisico_modificacion_m8,1),1)) * avg(financiero_vigente_m8)) p_fisico_m8,", 
						"  (avg(fisico_ejecutado_m9/ifnull(if(fisico_asignado+fisico_modificacion_m9>0,fisico_asignado+fisico_modificacion_m9,1),1)) * avg(financiero_vigente_m9)) p_fisico_m9,", 
						"  (avg(fisico_ejecutado_m10/ifnull(if(fisico_asignado+fisico_modificacion_m10>0,fisico_asignado+fisico_modificacion_m10,1),1)) * avg(financiero_vigente_m10)) p_fisico_m10,", 
						"  (avg(fisico_ejecutado_m11/ifnull(if(fisico_asignado+fisico_modificacion_m11>0,fisico_asignado+fisico_modificacion_m11,1),1)) * avg(financiero_vigente_m11)) p_fisico_m11,", 
						"  (avg(fisico_ejecutado_m12/ifnull(if(fisico_asignado+fisico_modificacion_m12>0,fisico_asignado+fisico_modificacion_m12,1),1)) * avg(financiero_vigente_m12)) p_fisico_m12", 
						"  from mv_financiera_fisica ", 
						"  where entidad=? and unidad_ejecutora=? and tipo_resultado=?", 
