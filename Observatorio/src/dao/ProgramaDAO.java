...
public class ProgramaDAO {
	...
	public static ArrayList<Programa> getProgramas(Integer entidad, Integer unidadEjecutora, Integer programa, String tipo_resultaldo){
		...
		try{
			if(CMemsql.connect()){
				query = String.join(" ", "select ejercicio, entidad, unidad_ejecutora, programa, programa_nombre,", 
						...
						"(sum(p_fisico_m1)/sum(financiero_vigente_m1)) pp_fisico_m1,", 
						"(sum(p_fisico_m2)/sum(financiero_vigente_m2)) pp_fisico_m2,", 
						"(sum(p_fisico_m3)/sum(financiero_vigente_m3)) pp_fisico_m3,", 
						"(sum(p_fisico_m4)/sum(financiero_vigente_m4)) pp_fisico_m4,", 
						"(sum(p_fisico_m5)/sum(financiero_vigente_m5)) pp_fisico_m5,", 
						"(sum(p_fisico_m6)/sum(financiero_vigente_m6)) pp_fisico_m6,", 
						"(sum(p_fisico_m7)/sum(financiero_vigente_m7)) pp_fisico_m7,", 
						"(sum(p_fisico_m8)/sum(financiero_vigente_m8)) pp_fisico_m8,", 
						"(sum(p_fisico_m9)/sum(financiero_vigente_m9)) pp_fisico_m9,", 
						"(sum(p_fisico_m10)/sum(financiero_vigente_m10)) pp_fisico_m10, ", 
						"(sum(p_fisico_m11)/sum(financiero_vigente_m11)) pp_fisico_m11,", 
						"(sum(p_fisico_m12)/sum(financiero_vigente_m12)) pp_fisico_m12 ", 
						"from (", 
						"  select ejercicio, entidad, unidad_ejecutora, programa, programa_nombre, subprograma, proyecto, obra, actividad, actividad_obra_nombre,", 
						...
						"  (AVG(IFNULL(fisico_ejecutado_m1, IF (fisico_asignado + IFNULL(fisico_modificacion_m1,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m1,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m1,0),1))*AVG(IFNULL(financiero_vigente_m1,0))) p_fisico_m1,", 
						"  (AVG(IFNULL(fisico_ejecutado_m2, IF (fisico_asignado + IFNULL(fisico_modificacion_m2,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m2,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m2,0),1))*AVG(IFNULL(financiero_vigente_m2,0))) p_fisico_m2,", 
						"  (AVG(IFNULL(fisico_ejecutado_m3, IF (fisico_asignado + IFNULL(fisico_modificacion_m3,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m3,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m3,0),1))*AVG(IFNULL(financiero_vigente_m3,0))) p_fisico_m3,", 
						"  (AVG(IFNULL(fisico_ejecutado_m4, IF (fisico_asignado + IFNULL(fisico_modificacion_m4,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m4,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m4,0),1))*AVG(IFNULL(financiero_vigente_m4,0))) p_fisico_m4,", 
						"  (AVG(IFNULL(fisico_ejecutado_m5, IF (fisico_asignado + IFNULL(fisico_modificacion_m5,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m5,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m5,0),1))*AVG(IFNULL(financiero_vigente_m5,0))) p_fisico_m5,", 
						"  (AVG(IFNULL(fisico_ejecutado_m6, IF (fisico_asignado + IFNULL(fisico_modificacion_m6,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m6,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m6,0),1))*AVG(IFNULL(financiero_vigente_m6,0))) p_fisico_m6,", 
						"  (AVG(IFNULL(fisico_ejecutado_m7, IF (fisico_asignado + IFNULL(fisico_modificacion_m7,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m7,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m7,0),1))*AVG(IFNULL(financiero_vigente_m7,0))) p_fisico_m7,", 
						"  (AVG(IFNULL(fisico_ejecutado_m8, IF (fisico_asignado + IFNULL(fisico_modificacion_m8,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m8,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m8,0),1))*AVG(IFNULL(financiero_vigente_m8,0))) p_fisico_m8,", 
						"  (AVG(IFNULL(fisico_ejecutado_m9, IF (fisico_asignado + IFNULL(fisico_modificacion_m9,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m9,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m9,0),1))*AVG(IFNULL(financiero_vigente_m9,0))) p_fisico_m9,", 
						"  (AVG(IFNULL(fisico_ejecutado_m10, IF (fisico_asignado + IFNULL(fisico_modificacion_m10,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m10,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m10,0),1))*AVG(IFNULL(financiero_vigente_m10,0))) p_fisico_m10,", 
						"  (AVG(IFNULL(fisico_ejecutado_m11, IF (fisico_asignado + IFNULL(fisico_modificacion_m11,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m11,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m11,0),1))*AVG(IFNULL(financiero_vigente_m11,0))) p_fisico_m11,", 
						"  (AVG(IFNULL(fisico_ejecutado_m12, IF (fisico_asignado + IFNULL(fisico_modificacion_m12,0) > 0, 0, NULL)) / IF (fisico_asignado + IFNULL(fisico_modificacion_m12,0) > 0,fisico_asignado + IFNULL(fisico_modificacion_m12,0),1))*AVG(IFNULL(financiero_vigente_m12,0))) p_fisico_m12", 
						"  from mv_financiera_fisica ", 
						"  where entidad=? and unidad_ejecutora=? and tipo_resultado=? and proyecto=0", 
