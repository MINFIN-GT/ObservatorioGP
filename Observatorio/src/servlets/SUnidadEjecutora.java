...
import dao.UnidadEjecutoraDAO.UnidadEjecutora;
...
public class SUnidadEjecutora extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer val_resultado = Utils.String2Int(map.get("val_resultado"));
		...
		if(accion.equals("getUnidadesEjecutoras")){
			ArrayList<UnidadEjecutora> lstunidadesejecutoras = UnidadEjecutoraDAO.getUnidadesEjecutoras(val_resultado, tipo_resultado, entidad);
			
			String unidadesEjecutoras = new GsonBuilder().serializeNulls().create().toJson(lstunidadesejecutoras);
			response_text = String.join(" ", "\"unidadesEjecutoras\": ", unidadesEjecutoras);
